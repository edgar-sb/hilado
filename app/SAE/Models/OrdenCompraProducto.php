...
class OrdenCompraProducto extends Model
{
    public function __construct(array $attributes = [])
    {
        ...
        $this->table = "PAR_COMPO".env("DB_TABLES_SUFIX","01");
    }

    protected $connection = 'firebird';
    //protected $table = 'PAR_COMPO01';
    ...
    public function esquema() {
        return $this->belongsTo(Esquema::class, 'CVE_ESQ', 'CVE_ESQIMPU');
    }

    public function observacion() {
        return $this->hasOne(Observacion::class, 'CVE_OBS', 'CVE_OBS');
    }

    public function getImporteIntAttribute() {
        return $this->partida_int + $this->impuesto_int - $this->descuento_int;
    }
    public function getPartidaIntAttribute() {
    ...
    public function getIvaIntAttribute() {
        return $this->IMPU4 * 100;
    }
    public function getRetIvaIntAttribute() {
        return $this->IMPU2 * 100;
    }
    ...
    public function getImporteFormatAttribute() {
        return "$".number_format(($this->TOT_PARTIDA) + ($this->TOTIMP1 + $this->TOTIMP2 +  $this->TOTIMP3 +  $this->TOTIMP4) - ($this->DESCU), 2);
    }
    ...
    public function getIvaFormatAttribute() {
        return "$".number_format($this->IMPU4, 2);
    }
    public function getRetIvaFormatAttribute() {
        return "$".number_format($this->IMPU2, 2);
    }
}

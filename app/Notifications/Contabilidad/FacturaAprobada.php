...
class FacturaAprobada extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $mail->subject('Contabilidad: Factura aprobada OC: #'.$this->compra->no_compra);
        $mail->greeting('Hola '.$this->user->nombre.',');
        $mail->introLines = [
            'El proveedor de la compra: #'.$this->compra->no_pedido.' ha adjuntado la factura correspondiente.',
        ];

...
class ComplementoPendiente extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $mail->subject('Proveedor: Complemento de pago pendiente OC: #'.$this->compra->no_compra);
        $mail->greeting('Hola '.$this->user->nombre.',');
        $mail->introLines = [
            'Se ha realizado el pago de la compra con número de orden : #'.$this->compra->no_pedido.'.',
        ];
